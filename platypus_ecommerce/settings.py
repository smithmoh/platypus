...
#jazzmin for admin settings
JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Platypus Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Platypus",
    ...
    "welcome_sign": "Welcome to the Platypus",

    # Copyright on the footer
    "copyright": "Acme Haust technology Ltd",
    ...
    "order_with_respect_to": ["auth", "store", "users.author", "users.store"],
